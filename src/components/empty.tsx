...
const Empty: React.FC<Props> = ({}) => {
  return (
    <>
      <div className="section-top flex flex-col gap-6">
        <motion.div
        ...
        >
          In the world of office rentals, every query without results is a step
          closer to discovering a hidden gem. Keep exploring; your perfect
          office space is out there on the horizon.
        </motion.p>
        <motion.button
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
      ...
      <div className="section-top w-full overflow-x-hidden">
        <motion.p
